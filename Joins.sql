...
copy customers from 'D:/SQL ARC/Table.1--customers.csv' delimiter ',' csv header;
copy orders from 'D:/SQL ARC/Table.2--orders.csv' delimiter ',' csv header;
copy products from 'D:/SQL ARC/Table.3--products.csv' delimiter ',' csv header;
copy order_items from 'D:/SQL ARC/Table.4--order_items.csv' delimiter ',' csv header;
